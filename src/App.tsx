        ...
        if (loadedData) {
          ...
          setPageData({
            ...
            welcome: {
              ...
              ...(loadedData.welcome || {}),
              subtitle1: (loadedData.welcome as any)?.subtitle1 || (INITIAL_DATA.welcome as any).subtitle1,
              accordion2: (loadedData.welcome as any)?.accordion2 || INITIAL_DATA.welcome.accordion2 || []
            },
